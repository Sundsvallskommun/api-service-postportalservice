...
/**
 * Publishes snail mail onto the messaging service's inbound exchange with routing key {@code snail-mail}. Behaviour
 * lives in
 * {@link QueuePublisher}.
 * <p>
...
public class SnailMailQueuePublisher extends QueuePublisher<SnailMailQueueMessage> {

	public SnailMailQueuePublisher(final RabbitTemplate rabbitTemplate, final RabbitIntegrationProperties properties) {
