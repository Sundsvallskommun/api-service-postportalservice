...
class PrecheckUtilTest {
	...
	@Test
	void normalizePersonalIdentityNumber() {
		assertThat(PrecheckUtil.normalizePersonalIdentityNumber("191111111111")).isEqualTo("191111111111");
		assertThat(PrecheckUtil.normalizePersonalIdentityNumber("19111111-1111")).isEqualTo("191111111111");
		assertThat(PrecheckUtil.normalizePersonalIdentityNumber("19111111 1111")).isEqualTo("191111111111");
		assertThat(PrecheckUtil.normalizePersonalIdentityNumber("19111111/1111")).isEqualTo("191111111111");
	}
